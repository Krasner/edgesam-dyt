...
# Only train image encoder DyT layers
_C.DISTILL.IMAGE_ENCODER_DYT = False
...
# If mask if unfrozen whether to only train DynamicTanh layers
_C.DISTILL.ONLY_TUNE_MASK_DECODER_DYT = False
...
# Use DyT in mask decoder
_C.DISTILL.MASK_DYT = False
# Use gelu approx in mask decoder
_C.DISTILL.GELU_APPROX = 'none'
